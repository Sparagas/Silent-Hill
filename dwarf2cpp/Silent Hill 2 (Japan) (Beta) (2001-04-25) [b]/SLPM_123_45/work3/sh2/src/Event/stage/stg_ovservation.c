...
typedef unsigned char type_6[24];
...
_anon3 ev_list[3];
int(*ev_prog)()[2];
_anon2 stage_observation;

int EvProgLetterFromMary();

// 
// Start address: 0x2314d0
int EvProgLetterFromMary()
{
	// Line 55, Address: 0x2314d0, Func Offset: 0
	// Line 56, Address: 0x2314d4, Func Offset: 0x4
	// Func End, Address: 0x2314dc, Func Offset: 0xc
}
