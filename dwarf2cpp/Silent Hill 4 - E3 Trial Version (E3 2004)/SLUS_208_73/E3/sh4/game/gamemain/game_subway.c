...
void GameSubwayInit();
void GameSubwayScene13Init();
void GameSubwaySceneInit();
void GameSubwaySceneExec();
void GameSubwaySceneEnd();
...
// 
// Start address: 0x1ed4080
void GameSubwaySceneExec()
{
	// Line 97, Address: 0x1ed4080, Func Offset: 0
	// Line 98, Address: 0x1ed4084, Func Offset: 0x4
	// Line 97, Address: 0x1ed4088, Func Offset: 0x8
	// Line 98, Address: 0x1ed408c, Func Offset: 0xc
	// Line 99, Address: 0x1ed409c, Func Offset: 0x1c
	// Line 100, Address: 0x1ed40a4, Func Offset: 0x24
	// Line 101, Address: 0x1ed40a8, Func Offset: 0x28
	// Line 104, Address: 0x1ed40bc, Func Offset: 0x3c
	// Line 108, Address: 0x1ed40c8, Func Offset: 0x48
	// Func End, Address: 0x1ed40d4, Func Offset: 0x54
}
