...
char data_demo_tsuri_hhh_jms_anm__name[28];
fsFile data_demo_tsuri_hhh_jms_anm__info[1];
fsFileIndex data_demo_tsuri_hhh_jms_anm[1];
char data_demo_tsuri_i_keyelevator_anm__name[34];
fsFile data_demo_tsuri_i_keyelevator_anm__info[1];
fsFileIndex data_demo_tsuri_i_keyelevator_anm[1];
char data_demo_tsuri_i_needle_anm__name[29];
fsFile data_demo_tsuri_i_needle_anm__info[1];
